...
function ticket()
{
	...
	if (!$api->UserHasItem($userid,203,1))
	{
		alert('danger',"Uh Oh!","You need a 2018 Christmas Scratch Ticket to be here.",true,'inventory.php');
		die($h->endpage());
	}
...
function snowcollect()
{
    ...
    if (isset($_GET['collect']))
    {
        ...
        if ($api->UserInfoGet($userid, 'brave', true) < 33)
        {
        ...
        $api->UserInfoSet($userid,'brave',-33,true);
    ...
    {
        echo "Would you like to collect some snow? It requires 100% energy, 25% Will and 33% Brave.<br />
