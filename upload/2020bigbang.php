...
{
    global $db,$h,$userid;
    echo "<h3>2020's Big Bang Event</h3><hr />";
    ...
    else
    {
        ...
        echo "The Big Bang Event is supposed a way to forget we're all stuck inside during COVID-19. So, 
        ...
        receive their choosing of $5 worth of VIP Packs, and 25 <a href='iteminfo.php?ID=205'>CID Admin Gym Access Scrolls</a>.
		After the event concludes, CID Admin will hand out participation items!<br />
        <b>Donate Small Explosives (Currently Donated: " . number_format($sc) . ")<br /></b>
        <form method='post'>
        ...
        <b>Donate Medium Explosives (Currently Donated: " . number_format($mc) . ")<br /></b>
        <form method='post'>
        ...
        <b>Donate Large Explosives (Currently Donated: " . number_format($lc) . ")<br /></b>
        <form method='post'>
