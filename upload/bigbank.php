...
{
    alert('danger',"Uh Oh!","Due to a recent robbery, the Federal Bank requires that every customer come in with at least one weapon equipped.",true,'explore.php');
    die($h->endpage());
}
if ($ir['equip_armor'] == 0)
{
    alert('danger',"Uh Oh!","Due to a recent robbery, the Federal Bank requires that every customer come in with armor equipped.",true,'explore.php');
    die($h->endpage());
}
$bank_cost = 10000000;
$bank_maxfee = 250000;
