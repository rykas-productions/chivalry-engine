...
class AJAXChat {
	...
	function getTemplateFileName() {
		switch($this->getView()) {
			...
			default:
				return AJAX_CHAT_PATH.'lib/template/loggedOut.php';
		}
	}
	...
	function createGuestUserName() {
		...
		$userName = substr(random_int(100000, 999999), 0, $maxLength);
	...
	function createGuestUserID() {
		...
		return random_int($this->getConfig('minGuestUserID'), $this->getConfig('privateChannelDiff')-1);
	}
