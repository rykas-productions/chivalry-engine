...
echo "<h3><i class='game-icon game-icon-weight-lifting-down'></i> Chivalry Gym</h3>";
...
The Chivlary Gym will give you " . number_format($multi*100) . "% the stats you'd gain at the Normal Gym.
<form method='post' id='gymTrainChiv'>
	<div class='card'>
		<div class='card-body'>
			<div class='row'>
			...
			<div class='row'>
				<div class='col-12 col-sm-6 col-md-2 col-lg-6 col-xl-2'>
					<input type='submit' class='btn btn-success btn-block' value='Train' id='trainChiv' /><br />
				</div>
