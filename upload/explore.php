...
echo "<h4>You begin exploring the town. You find a few things that could keep you occupied.</h4>
<div class='container'>
    <div class='row'>
        <div class='col-md-12'>
            <ul class='nav nav-tabs nav-justified mb-3' id='townTabs' role='tablist'>
                <li class='nav-item' role='presentation'>
                    <button class='nav-link active' data-bs-toggle='tab' data-bs-target='#SHOPS' type='button' role='tab' aria-selected='true'>Shopping District</button>
                </li>
                <li class='nav-item' role='presentation'>
                    <button class='nav-link' data-bs-toggle='tab' data-bs-target='#FD' type='button' role='tab' aria-selected='false'>Financial District</button>
                </li>
                <li class='nav-item' role='presentation'>
                    <button class='nav-link' data-bs-toggle='tab' data-bs-target='#HL' type='button' role='tab' aria-selected='false'>Working District</button>
                </li>
                <li class='nav-item' role='presentation'>
                    <button class='nav-link' data-bs-toggle='tab' data-bs-target='#ADMIN' type='button' role='tab' aria-selected='false'>Administration District</button>
                </li>
                <li class='nav-item' role='presentation'>
                    <button class='nav-link' data-bs-toggle='tab' data-bs-target='#GAMES' type='button' role='tab' aria-selected='false'>Gambling District</button>
                </li>
                <li class='nav-item' role='presentation'>
                    <button class='nav-link' data-bs-toggle='tab' data-bs-target='#GUILDS' type='button' role='tab' aria-selected='false'>Guilds District</button>
                </li>
                <li class='nav-item' role='presentation'>
                    <button class='nav-link' data-bs-toggle='tab' data-bs-target='#PINTER' type='button' role='tab' aria-selected='false'>Social District</button>
                </li>
            </ul>
            
            <div class='tab-content' id='townTabsContent'>
                <div class='tab-pane fade show active' id='SHOPS' role='tabpanel' tabindex='0'>
                    <div class='card'>
                        <div class='card-body'>
                ...
                <div class='tab-pane fade' id='FD' role='tabpanel' tabindex='0'>
                    <div class='card'>
                        <div class='card-body'>
                ...
                <div class='tab-pane fade' id='HL' role='tabpanel' tabindex='0'>
                    <div class='card'>
                        <div class='card-body'>
                ...
                <div class='tab-pane fade' id='GAMES' role='tabpanel' tabindex='0'>
                    <div class='card'>
                        <div class='card-body'>
                ...
                <div class='tab-pane fade' id='GUILDS' role='tabpanel' tabindex='0'>
                    <div class='card'>
                        <div class='card-body'>";
//User is in a guild.
if ($ir['guild'] > 0) {
...
echo "
                ...
                <div class='tab-pane fade' id='PINTER' role='tabpanel' tabindex='0'>
                    <div class='card'>
                        <div class='card-body'>
