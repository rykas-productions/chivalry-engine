...
function levelMultiplier($level, $reset = 1)
{
	...
	elseif (($level >= 1500) && ($level < 2000))
		$multiplier += 5;
	elseif (($level >= 2000) && ($level < 3000))
		$multiplier += 5.5;
	elseif (($level >= 3000) && ($level < 4000))
		$multiplier += 5.75;
	elseif (($level >= 4000) && ($level < 5000))
		$multiplier += 6;
	else
		$multiplier += 6.1;
	if ($actualReset > 0) {
...
function getOS($uagent)
{
	...
	$os_array = array(
		...
		'/windows phone 8.0/i' => 'Windows Phone 8',
		...
		'/android/i' => 'Android',
		'/iphone os 17/i' => 'iOS 17',
		'/iphone os 16/i' => 'iOS 16',
...
function getBrowser($uagent)
{
	...
	$browser_array = array(
		...
		'/avantbrowser/i' => 'Avant Browser',
		'/midori/i' => 'Midori',
		'/whale/i' => 'Naver Whale',
		'/chromium/i' => 'Chromium',
		'/palemoon/i' => 'Pale Moon',
		'/epiphany/i' => 'Epiphany',
		'/playstation 5/i' => 'Playstation 5 Browser',
		'/playstation 4/i' => 'Playstation 4 Browser',
		'/xbox one/i' => 'Xbox One Browser',
		'/xbox/i' => 'Xbox Browser',
		'/nintendo switch/i' => 'Nintendo Switch Browser',
...
function generateMerchantData($userid)
{
	...
	array_push(
		$stock,
		array("item" => $weapon, "qty" => Random(1, 3)),
		array("item" => $armor, "qty" => Random(1, 3)),
		array("item" => -1, "qty" => Random(500, 5000)),
		array("item" => 23, "qty" => Random(25, 100)),
		array("item" => 296, "qty" => Random(15, 75)),
		array("item" => 410, "qty" => Random(5, 35))
	);
