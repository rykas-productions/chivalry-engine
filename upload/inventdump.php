...
else
{
    ...
    echo "Done. That's " . number_format($totalcost) . " Copper Coins down the drain.";
    if ($totalcost > 500000000)
    {
        ...
        {
            echo "<br />Huh... you've dumped over 500M Copper Coins worth... you deserve the <b>Chump Change</b> achievement.";
