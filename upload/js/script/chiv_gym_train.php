...
{
    alert("danger", "Uh Oh!", "You need at least one Chivalry Gym Scroll to use the Chivalry Gym.", false);
    die($h->endpage());
}
	...
	else
	{
        ...
        if ($stat == "strength") {
            alert('success', "Success!", "You begin to lift weights. You have gained " . shortNumberParse($gain) . " Strength by completing
			    " . shortNumberParse($_POST['amnt']) . " sets of weights. You now have " . number_format($NewStatAmount) . " Strength and {$EnergyLeft} Energy left.", false);
        ...
        elseif ($stat == "agility") {
            alert('success', "Success!", "You begin to run laps. You have gained " . shortNumberParse($gain) . " Agility by completing
			    " . shortNumberParse($_POST['amnt']) . " laps. You now have " . number_format($NewStatAmount) . " Agility and {$EnergyLeft} Energy left.", false);
        ...
        elseif ($stat == "guard") {
            alert('success', "Success!", "You begin swimming in the pool. You have gained " . shortNumberParse($gain) . " Guard by swimming for
			    " . shortNumberParse($_POST['amnt']) . " minutes. You now have " . number_format($NewStatAmount) . " Guard and {$EnergyLeft} left.", false);
        ...
        elseif ($stat == "labor") {
            alert('success', "Success!", "You begin moving boxes around the gym. You have gained " . shortNumberParse($gain) . " Labor by moving
                " . shortNumberParse($_POST['amnt']) . " sets of boxes. You now have " . number_format($NewStatAmount) . " and {$EnergyLeft} Energy left.", false);
            //Have guard selected for the next training.
            $lab_select = "selected";
        ...
        $api->SystemLogsAdd($userid, 'training', "[Chivalry Gym] " . shortNumberParse($_POST['amnt']) . " energy for " . shortNumberParse($gain) . " {$stat}.");
        echo "<hr />";
