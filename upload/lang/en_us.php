...
$lang['TUT_HL_DETAIL']="You will find that the labor category is where you will spend a lot of your time at. <b>{$lang['EXPLORE_MINE']}</b> is a great place to find riches. Be careful though, as nearby warriors may get jealous of your haul. If you're too careless, you could also ignite a gas pocket, placing yourself into the <b>{$lang['EXPLORE_INFIRM']}</b>. The <b>{$lang['EXPLORE_SMELT']}</b> can be used to smelt your items gained while mining, into better items. Obviously, you will need the required items for this to work. <b>{$lang['EXPLORE_WC']}</b> will allow you to chop trees to sell for cold, hard currency. <b>{$lang['EXPLORE_FARM']}</b> will allow you to channel your farmer. You can use the harvested crops to create better foods, or sell for a profit. Finally, the <b>{$lang['EXPLORE_BOTS']}</b> will allow you to quickly attack NPCs. If you mug the NPCs listed, you will be able to get a special item drop. Note that this can only happen once per each bot's cooldown time.";
$lang['TUT_ADMIN']=$lang['EXPLORE_ADMIN'];
$lang['TUT_ADMIN_DETAIL']="This category has no general theme, to be honest. Checking out <b>{$lang['EXPLORE_USERLIST']}</b> will list all the registered users in-game, and allow you to organize them by {$lang['INDEX_LEVEL']}, ID, {$lang['INDEX_PRIMCURR']} or name. Clicking <b>{$lang['UOL_TITLE']}</b> will list the players online in the last 15 minutes. You can customize this to any duration you wish. <b>{$lang['EXPLORE_STAFFLIST']}</b> will list all in-game staff. These players uphold the law and order of the game. If you have any issue, you should contact them! The <b>{$lang['EXPLORE_FED']}</b> is where bad folks go. If you follow the rules, you won't ever have to get locked up. If you get locked up, you will lose access to almost all game features. <b>{$lang['EXPLORE_STATS']}</b> will list you game statistics. There's a lot shown here, so check it out to get an idea! If you suspect a player breaking a rule, use the <b>{$lang['EXPLORE_REPORT']}</b> link to report them. Reports here are anonymous, and won't be used in investigations aginst players. If you abuse this form, however, you will be dealt with harshly. Finally, <b>{$lang['EXPLORE_ANNOUNCEMENTS']}</b> will show you announcements posted by staff members. A lot of important information or changes will be listed here.";
$lang['TUT_GAMES']=$lang['EXPLORE_GAMES'];
$lang['TUT_GAMES_DETAIL']="We have several games for you to play to keep your mind off the stress of the game. Games inside of a game. Isn't this how you destroy the world? In either case, <b>{$lang['EXPLORE_RR']}</b> is a deadly game that you can challenge your friends to. You point a gun to each other's games until someone is shot. If you're shot, game over. If that's too high risk for you, how about trying out <b>{$lang['EXPLORE_HILO']}</b>? Simply decide if the next drawn number will be higher or lower than the current number. If you're right, you pocket some extra {$lang['INDEX_PRIMCURR']}. If you want a little more thrill, check out <b>{$lang['EXPLORE_ROULETTE']}</b>! Pick a number, bet on it, and hope you win! Finally, if you want to play a game of chance, how about betting at the <b>{$lang['EXPLORE_SLOTS']}</b>?";
$lang['TUT_GUILDS']=$lang['EXPLORE_GUILDS'];
$lang['TUT_GUILDS_DETAIL']="Hovering over the <b>{$lang['EXPLORE_GUILDS']}</b> section will display links pertaining to guilds. Firstly, if you have joined a guild, <b>{$lang['EXPLORE_YOURGUILD']}</b> will take you to view your guild. However, this is useless if you aren't in a guild. To join a guild, or view possible enemies of your own guild, clicking on <b>{$lang['EXPLORE_GUILDLIST']}</b> will list all the guilds in the game. Clicking on a guild's name will allow you to view detailed information about the guild. If you're curious about guild feuds, however, clicking on <b>{$lang['EXPLORE_WARS']}</b> will list all active guild wars. You will find more about the usefulness of guilds later in the tuorial.";
$lang['TUT_ACT']=$lang['EXPLORE_ACT'];
$lang['TUT_ACT_DETAIL']="Opening the activities section will allow you to view numerous things to do around the game. Firstly, the <b>{$lang['EXPLORE_DUNG']}</b> will list the players in the dungeon. You will be placed here if you commit crimes and are caught. The <b>{$lang['EXPLORE_INFIRM']}</b> will show those who are receiving medical treatment. You will be placed here if you sustain excessive injuries. To get stronger in game, we suggest bulking up at the <b>{$lang['EXPLORE_GYM']}</b>. Here you may train your stats. The importance of these stats are explained in the <a href='#basics'>basics</a>. You cannot get spending cash until you work, so we suggest finding work by clicking on <b>{$lang['EXPLORE_JOB']}</b>. Here you will be paid, based on your rank in the company you wish to work for. Different companies pay different rates, and have different requirements. More information about this later. Visiting the <b>{$lang['EXPLORE_ACADEMY']}</b> will allow you to enroll in a course. Courses cost money, and after the course finishes, you will be awarded will a substantial amount of stats. Courses may have other requirements. If you're wanting to make some quick, but risky money, try chekcing out the <b>{$lang['EXPLORE_CRIMES']}</b>. Here you can commit crimes, which cost {$lang['INDEX_BRAVE']}. There's the chance you will be caught. The success rate is determined by your {$lang['INDEX_LEVEL']}, {$lang['INDEX_WILL']}, and most definitely {$lang['GEN_IQ']}. Finally, clicking <b>{$lang['EXPLORE_TUTORIAL']}</b> will load the game tutorial for you to read. If you are ever confused, view the tutorial. Oh wait... you already are.";
$lang['TUT_PINTER']=$lang['EXPLORE_PINTER'];
$lang['TUT_PINTER_DETAIL']="Opening the {$lang['EXPLORE_PINTER']} section will allow you to view ways you can interact with other players in a public setting. <b>{$lang['EXPLORE_FORUMS']}</b> will allow you to view the in-game forums. You can create your own threads, and reply to others. Remember, don't get upset if someone gives you a hard time, its all in good fun. Viewing the game's <b>{$lang['EXPLORE_NEWSPAPER']}</b> will allow you see aads posted by other players. You can, of course, post your own ads. You can write about anything here, awesome enough. Finally, the <b>{$lang['POLL_TITLE']}</b> will be home of polls the staff members create, which you can vote in. You can alos view the results of the previous polls here as well. Polls are used to get an idea of how other players feel about changes in-game.";
$lang['TUT_TOPTEN']=$lang['EXPLORE_TOPTEN'];
$lang['TUT_TOPTEN_DETAIL']="The {$lang['EXPLORE_TOPTEN']} listing will list the top ten strongest players in the game, in order of total stats. These are the players you want to beat. Its a high honor to be a part of this list. It takes lots of time and dedication to get here. Don't be upset if you can't get here.";
$lang['TUT_REFFERAL']="Refferal Link";
...
$lang['TUT_POWERTRAIN_DETAIL']="Power training is the term used to describe when you spend excessive amounts of time, patience and skill training your stats to have a signifcant increase. Power training blows through your resources quickly, so its a good idea to make sure you have enough {$lang['INDEX_SECCURR']} before you start power training. The idea is to have your {$lang['INDEX_WILL']} maxed out, and train using all your {$lang['INDEX_ENERGY']} in one session, then refilling both your {$lang['INDEX_ENERGY']} and {$lang['INDEX_WILL']} before training again. This is complex, so don't worry if you do not understand how this works. There's also many ways of doing this, so you may end up creating your own style of power training.";
$lang['TUT_GGYM']="Guild Gym";
$lang['TUT_GGYM_DETAIL']="The guild gym becomes available to you when you join a guild, and the guild is above level 3. The guild gym has the advantage of having increased stat output compared to the normal gym. You will gain 2% more stats per guild level, up to a maximum of double your maximum gains.";
