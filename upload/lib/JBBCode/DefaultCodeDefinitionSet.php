...
class DefaultCodeDefinitionSet implements CodeDefinitionSet
{
    ...
    public function __construct()
    {
        ...
        /* [img] image tag */
        $builder = new CodeDefinitionBuilder('img', '<img src="https://www.chivalryisdeadgame.com/img-redirect.php?url={param}" class="img-fluid" />');
        $builder->setUseOption(false)->setParseContent(false)->setBodyValidator($urlValidator);
        array_push($this->definitions, $builder->build());

        /* [img=alt text] image tag */
        $builder = new CodeDefinitionBuilder('img', '<img src="https://www.chivalryisdeadgame.com/img-redirect.php?url={param}" class="img-fluid" alt="{option}" />');
