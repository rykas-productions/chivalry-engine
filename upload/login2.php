...
<div class="row featurette">
          <div class="col-md-7">
            ...
            <p class="lead">You are a young warrior from the town of Cornrye. You must travel to different towns and meet new people. Will you protect the weak, or destroy them? The choice is yours, but remember, there's always a consequence.</p>
          </div>
          <div class="col-md-5">
        ...
        <div class="row featurette">
          <div class="col-md-7 order-md-2">
            ...
            <p class="lead">You will be able to make loads of wealth. How you do so is entirely up to you! Would you rather get it honorably by taking bounty hits and working hard, or by dedicating yourself to a life of crime?</p>
          </div>
        ...
        <div class="row featurette">
          <div class="col-md-7">
            ...
            <p class="lead">You will need to travel to many different places outside of your hometown of Cornrye. Will you form a guild to protect the weak, or to extort them? The choice is yours in Chivalry Is Dead. Join now to figure out whether your gameplay is as sharp as your blade.</p>
          </div>
          <div class="col-md-5">
