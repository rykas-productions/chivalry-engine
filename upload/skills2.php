...
function home()
{
    ...
    <ul class="nav nav-tabs nav-justified">
		...
		<li class='nav-item'>
            <a class='nav-link' data-toggle="tab" href="#class">Class Universal</a>
        </li>
    </ul>
    <br />
            ...
            <?php
                echo "<table class='table'>
                    <tr>
                        ...
                        <td {$locked[31]} width='33%'>
                            Conditioning (1 Point)<br />
                            <small>+2.5% Class Weak stat, -1% Class Strong Stat per level.<br /></small>
                            " . getSkillLevel($userid,31) . " / 5
                            <br />
                            {$button['31']}
                        </td>
                        <td {$locked[32]} width='33%'>
                            Potent Potion (1 Point)<br />
                            <small>+1.5% more potion ability when used in combat, per level.<br /></small>
                            " . getSkillLevel($userid,32) . " / 5
                            <br />
                            {$button['32']}
                        </td>
                    </tr>
...
{
    $onepoint = array(1,2,3,11,12,13,22,23,30,31,32);
    $threepoint = array(4,5,6,14,15,16,24,25,26,33,34,35);
    $fivepoint = array(7,8,9,17,18,19,21,27,28,29,36,37,38);
...
function canGetSkill($id)
{
	...
	{
		$fixedid=$id-3;
        $alwaysbuy=array(1,2,3,11,12,13,21,22,23,30,31,32);
