                    ...
                    <div class='row'>";
                        ...
                        if ($api->UserMemberLevelGet($userid, 'admin'))
                        {
                            echo "<div class='col-auto'>
                                ...
                                <div class='col-auto'>
                                    <a href='staff_estates.php?action=giftestate' class='btn btn-success btn-block'>Gift Estate</a><br />
                                </div>";
                        }
                        echo"
                        <div class='col-auto'>
                        ...
                        <div class='col-auto'>
                            <a href='staff_punish.php?action=directemail' class='btn btn-secondary btn-block'>Direct Email</a><br />
                        </div>
                        <div class='col-auto'>
