	...
	if (!isset($_POST['name']))
	{
		...
		<form method='post'>
			<table class='table table-bordered table-responsive'>
				...
				<td colspan='2'>
					<input type='submit' value='{$lang['STAFF_CRIME_NEW_BTN']}' class='btn btn-secondary'>
				</td>
				{$csrf}
			</table>
		</form>";
...
function edit_crime()
{
	...
	if ($_POST['step'] == 0)
	{
		...
		<table class='table table-bordered'>
			...
			<tr>
				<td colspan='2'>
					<input type='submit' class='btn btn-secondary' value='{$lang['STAFF_CRIME_EDIT_START_BTN']}'>
				</td>
			</tr>
		</table>
	...
	if ($_POST['step'] == 1)
	{
		...
		<form method='post'>
			<table class='table table-bordered table-responsive'>
				...
				<td colspan='2'>
					<input type='submit' value='{$lang['STAFF_CRIME_EDIT_START_BTN']}' class='btn btn-secondary'>
				</td>
				{$csrf}
			</table>
...
function delcrime()
{
	...
	else
	{
		...
		<table class='table table-bordered'>
			...
			<tr>
				<td colspan='2'>
					<input type='submit' value='{$lang['STAFF_CRIME_DEL_BTN']}' class='btn btn-secondary'>
				</td>
			</tr>
			{$csrf}
		</table>
	...
	else
	{
		...
		<form method='post'>
			<table class='table table-bordered table-responsive'>
				...
				<tr>
					<td colspan='2'>
						<input type='submit' value='{$lang['STAFF_CRIMEG_NEW_BTN']}' class='btn btn-secondary'>
					</td>
				</tr>
				{$csrf}
			</table>
...
function edit_crimegroup()
{
	...
	if ($_POST['step'] == 0)
	{
		...
		<table class='table table-bordered'>
			...
			<tr>
				<td colspan='2'>
					<input type='submit' class='btn btn-secondary' value='{$lang['STAFF_CRIMEG_EDIT_START_BTN']}'>
				</td>
			</tr>
		</table>
		{$csrf}
...
function delcrimegroup()
{
	...
	else
	{
		...
		<table class='table table-bordered'>
			...
			<tr>
				<td colspan='2'>
					<input type='submit' value='{$lang['STAFF_CRIMEG_DEL_BTN']}' class='btn btn-secondary'>
				</td>
			</tr>
			{$csrf}
		</table>
