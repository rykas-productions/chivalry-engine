...
function addestate()
{
	...
	else
	{
		...
		<table class='table table-bordered'>
			...
			<tr>
				<td colspan='2'>
					<input type='submit' class='btn btn-secondary' value='{$lang['STAFF_ESTATE_ADD_BTN']}'>
				</td>
			</tr>
			{$csrf}
		</table>
	...
	else
	{
		...
		echo "<form method='post'>
			<table class='table table-bordered'>
				...
				<tr>
					<td colspan='2'>
						<input type='submit' class='btn btn-secondary' value='{$lang['STAFF_ESTATE_DEL_BTN']}'>
					</td>
				</tr>
			</table>
			{$csrf}
...
function editestate()
{
	...
	if ($_POST['step'] == 1)
	{
		...
		<table class='table table-bordered'>
			...
			<tr>
				<td colspan='2'>
					<input type='submit' class='btn btn-secondary' value='{$lang['STAFF_ESTATE_EDIT_BTN']}'>
				</td>
			</tr>
			{$csrf}
