    ...
    else
    {
        ...
        <table class='table table-bordered'>
            <form method='post'>
                ...
                <tr>
                    <td colspan='2'>
                        <input type='submit' class='btn btn-default' value='{$lang['STAFF_MINE_ADD_BTN']}'>
                    </td>
                </tr>
            </form>
        </table>";
...
function editmine()
{
        ...
        else
        {
            ...
            <table class='table table-bordered'>
                ...
                <input type='hidden' value='{$mine}' name='mineid'>
                    ...
                    <tr>
                        <td colspan='2'>
                            <center><input type='submit' class='btn btn-default' value='{$lang['STAFF_MINE_EDIT_BTN']}'></center>
                        </td>
                    </tr>
                </form>
            </table>";
    ...
    else
    {
        ...
        <input type='submit' class='btn btn-default' value='{$lang['STAFF_MINE_EDIT_BTN']}'>
        ";
    }
}
function delmine()
{
    ...
    else
    {
        ...
        <form method='post'>
        " . mines_dropdown("mine") . "<br />
        <input type='submit' class='btn btn-default' value='{$lang['STAFF_MINE_DEL_BTN']}'>
        ";
    }
}
