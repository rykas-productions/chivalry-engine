...
function addtown()
{
	...
	else
	{
		...
		<table class='table table-bordered'>
			...
			<tr>
				<td colspan='2'>
					<input type='submit' class='btn btn-secondary' value='{$lang['STAFF_TRAVEL_ADDTOWN_BTN']}'>
				</td>
			</tr>
			{$csrf}
		</table>
	...
	else
	{
		...
		<form action='?action=deltown' method='post'>
			<table class='table table-bordered'>
				...
				<tr>
					<td colspan='2'>
						<input type='submit' class='btn btn-secondary' value='{$lang['STAFF_TRAVEL_DELTOWN_BTN']}'>
					</td>
				</tr>
				{$csrf}
			</table>
